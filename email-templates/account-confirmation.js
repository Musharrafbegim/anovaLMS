...
export const confirmEmailAddress = async (user) => {
	...
	const data = {
		to: user.email,
		from: "Anova LMS Online Courses <hello@envytheme.com>",
                        ...
                        <tr>
                            <td>
                                <div class="text" style="padding: 0 2.5em; text-align: left;">
                                    ...
                                    <p>Thanks for registering on the Anova LMS! Please click the below link to verify your email address and activate your account.</p>
                                    ...
                                    <p>
                                        Regards, <br />
                                        Anova LMS Support Team <br />
                                        All Rights Reserved by Anova LMS.com
                                    </p>
                                </div>
                            </td>
                        </tr>
              ...
              <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                          ...
                          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                              ...
                              <p style="text-align: center; margin-bottom: 0; margin-top: 5px">
                                  <a href="http://Anova LMS.com/" target="_blank" style="color: #3056de">www.Anova LMS.com</a>
                              </p>
                              </td>
                            </tr>
                          </table>
                ...
                <tr>
                  <td class="bg_light" style="text-align: center;">
                    <p>&copy;2022 Anova LMS Support</p>
                  </td>
                </tr>
              </table>
